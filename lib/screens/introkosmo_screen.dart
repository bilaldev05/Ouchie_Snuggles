...
class IntroKosmoScreen extends StatefulWidget {
  const IntroKosmoScreen({super.key});

  @override
  State<IntroKosmoScreen> createState() => _IntroKosmoScreenState();
}

class _IntroKosmoScreenState extends State<IntroKosmoScreen>
        ...
        children: [
          ...
          ScaleTransition(
            ...
            child: Align(
              ...
              child: Transform.translate(
                ...
                child: Image.asset("lib/assets/images/kosmo.png", height: 380),
              ),
            ),
          ),
          ...
          Align(
            ...
            child: Padding(
              ...
              child: PngButton(
                size: 260,
                pngAsset: "lib/assets/icons/next_btn.png",
                onTap: () {
                  context.go('/grownup');
                },
              ),
